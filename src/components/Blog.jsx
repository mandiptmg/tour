...
const blog = () => {
  return (
    <div id='blog' className='my-20 bg-[#111]'>
      <h1 className='p-20 text-xl md:text-4xl font-semibold'>Read awesome blog</h1>
      <div className='grid gap-7'>
        ...
        <div className='px-20'>
         <button className='text-xl bg-orange-500 px-4 py-2 mt-10 capitalize mb-20'>see all move</button>
        </div>
      </div>
    </div>
  )
